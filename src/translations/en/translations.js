const TRANSLATIONS_EN = {
  ...
  experiencePageJobs: [
    ...
    },
    {
      ...
      content: [
        "General tablet app debug and implementation of new features",
        "Management of package loss on unstable wifi connections",
        "Implementation of several automation with Ionic Appflow: native builds generation (APK, AAB & IPA) sync with GitHub, web preview, live udpate (update of tablets without going through the app store validation), app publication on the Android and Apple stores.",
